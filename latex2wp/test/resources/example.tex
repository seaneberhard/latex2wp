...
\input{macrosblog}  % not recognized by latex2wp

% macros defined by def should be picked up
\def\to{\rightarrow}
\def\B{\{ 0,1 \}}
...
Comments can be inserted in the usual way using the \% character.% here is an example
